...
class LevelViewSpec extends Specification {
    ...
    def "spike visitor"(x, y, xp, yp, xf, yf, cy) {
        ...
        then:
        1 * output.drawRectangle(xf, yf, 10, 1, spikeColor)
        1 * output.drawRectangle(xf + 1, yf + 1, 8, 1, spikeColor)
    ...
    def 'reversedSpike visitor'(x, y, xp, yp, xf, yf, cy) {
        ...
        then:
        1 * output.drawRectangle(xf, yf + 9, 10, 1, spikeColor)
        1 * output.drawRectangle(xf + 1, yf + 8, 8, 1, spikeColor)
    ...
    def 'doubleJump visitor'() {
        ...
        then:
        1 * output.drawCircle(xf, yf, 2, doubleJumpColor)
